...
<div class="row">
	...
	<div class="col-md-8 text-justify">
		<br>
		<p>Obtenga el mejor software del mercado, marcando la diferencia en estabilidad, condianza y seguridad, Oracle ofrece software de la mas alta calidad. Obtenga licencias de software Oracle <a href="{{ URL::to('contacto') }}">comunicandose con nosotros.</a></p>
...
<div class="row">
	...
	<div class="col-md-6 text-justify">
		...
		<p>Si deseas ponerte en contacto con nosotros  <a href="{{ URL::to('contacto') }}">envianos un mensaje.</a></p>
		<div>
		</div>
	</div>
